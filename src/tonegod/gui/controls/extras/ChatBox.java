...
public abstract class ChatBox extends Panel {
	 ...
	 */
	public ChatBox(ElementManager screen, Vector2f position) {
	 ...
	 */
	public ChatBox(ElementManager screen, Vector2f position, Vector2f dimensions) {
	 ...
	 */
	public ChatBox(ElementManager screen, Vector2f position, Vector2f dimensions, Vector4f resizeBorders, String defaultImg) {
	 ...
	 * @param position A Vector2f containing the x/y position of the Element
	 */
	public ChatBox(ElementManager screen, String UID, Vector2f position) {
	 ...
	 * @param dimensions A Vector2f containing the width/height dimensions of the Element
	 */
	public ChatBox(ElementManager screen, String UID, Vector2f position, Vector2f dimensions) {
	 ...
	 * @param defaultImg The default image to use for the Slider's track
	 */
	public ChatBox(ElementManager screen, String UID, Vector2f position, Vector2f dimensions, Vector4f resizeBorders, String defaultImg) {
