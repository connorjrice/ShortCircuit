 ...
 * Adapted from Cay Horstmann's Big Java (Early Objects)
 * @author Connor Rice
 */
public class BinarySearchTree<T extends Comparable> {
    ...
    public boolean contains(Comparable obj) {
        ...
        while (current != null) {
            ...
            if (d == 0) return true;
            else if (d > 0) current = current.getLeftChild();
    ...
    public void remove(Comparable obj) {
        ...
        while (!found && doomedNode != null) {
            ...
            if (d == 0) found = true;
                ...
                parent = doomedNode;
                if (d > 0) doomedNode = doomedNode.getLeftChild();
                else doomedNode = doomedNode.getRightChild();
            }
        }
